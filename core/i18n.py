...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "compare.grid.left": {LANG_VI: "Bảng A", LANG_JP: "テーブル A"},
    "compare.grid.right": {LANG_VI: "Bảng B", LANG_JP: "テーブル B"},
    ...
    "main.ttl.dialog.title": {LANG_VI: "Quản lý TTL", LANG_JP: "TTLランチャー"},
