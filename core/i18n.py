...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "main.btn.history": {LANG_VI: "Lich su thao tac", LANG_JP: "Action History"},
    ...
    "insert.btn.save_template": {LANG_VI: "Luu template", LANG_JP: "Save Template"},
    "insert.btn.select_template": {LANG_VI: "Chon template", LANG_JP: "Choose Template"},
    ...
    "update.btn.save_template": {LANG_VI: "Luu template", LANG_JP: "Save Template"},
    "update.btn.select_template": {LANG_VI: "Chon template", LANG_JP: "Choose Template"},
    ...
    # --- Template Library ---
    "template.save.title": {LANG_VI: "Luu template", LANG_JP: "Save Template"},
    "template.save.name": {LANG_VI: "Ten template", LANG_JP: "Template Name"},
    "template.save.description": {LANG_VI: "Mo ta", LANG_JP: "Description"},
    "template.save.type": {LANG_VI: "Loai", LANG_JP: "Type"},
    "template.save.message_missing": {LANG_VI: "Vui long nhap ten template.", LANG_JP: "Please enter template name."},
    "template.save.message_no_sql": {LANG_VI: "Khong co SQL de luu.", LANG_JP: "No SQL to save."},
    "template.save.message_saved": {LANG_VI: "Da luu template.", LANG_JP: "Template saved."},
    "template.dialog.title": {LANG_VI: "Thu vien template", LANG_JP: "Template Library"},
    "template.dialog.column.name": {LANG_VI: "Ten", LANG_JP: "Name"},
    "template.dialog.column.type": {LANG_VI: "Loai", LANG_JP: "Type"},
    "template.dialog.column.description": {LANG_VI: "Mo ta", LANG_JP: "Description"},
    "template.dialog.column.created": {LANG_VI: "Tao luc", LANG_JP: "Created"},
    "template.dialog.preview": {LANG_VI: "Noi dung", LANG_JP: "Content"},
    "template.dialog.btn.apply": {LANG_VI: "Su dung", LANG_JP: "Apply"},
    "template.dialog.btn.copy": {LANG_VI: "Copy", LANG_JP: "Copy"},
    "template.dialog.btn.delete": {LANG_VI: "Xoa", LANG_JP: "Delete"},
    "template.dialog.btn.close": {LANG_VI: "Dong", LANG_JP: "Close"},
    "template.dialog.confirm_delete": {LANG_VI: "Xoa template nay?", LANG_JP: "Delete this template?"},
    "template.dialog.no_selection": {LANG_VI: "Chua chon template.", LANG_JP: "No template selected."},
    "template.dialog.empty": {LANG_VI: "Thu vien dang rong.", LANG_JP: "Library is empty."},


    # --- History ---
    "history.title": {LANG_VI: "Lich su thao tac", LANG_JP: "Action History"},
    "history.column.time": {LANG_VI: "Thoi gian", LANG_JP: "Time"},
    "history.column.type": {LANG_VI: "Loai", LANG_JP: "Type"},
    "history.column.object": {LANG_VI: "Doi tuong", LANG_JP: "Object"},
    "history.column.rows": {LANG_VI: "So dong", LANG_JP: "Rows"},
    "history.column.status": {LANG_VI: "Trang thai", LANG_JP: "Status"},
    "history.column.message": {LANG_VI: "Thong diep", LANG_JP: "Message"},
    "history.column.sql": {LANG_VI: "SQL", LANG_JP: "SQL"},
    "history.filter.type": {LANG_VI: "Loc theo loai", LANG_JP: "Filter by type"},
    "history.filter.all": {LANG_VI: "Tat ca", LANG_JP: "All"},
    "history.search.placeholder": {LANG_VI: "Nhap tu khoa", LANG_JP: "Enter keyword"},
    "history.btn.refresh": {LANG_VI: "Tai lai", LANG_JP: "Refresh"},
    "history.btn.detail": {LANG_VI: "Xem chi tiet", LANG_JP: "View Detail"},
    "history.btn.export_csv": {LANG_VI: "Xuat CSV", LANG_JP: "Export CSV"},
    "history.detail.title": {LANG_VI: "Chi tiet hanh dong", LANG_JP: "Action Detail"},
    "history.detail.message": {LANG_VI: "Thong diep", LANG_JP: "Message"},
    "history.detail.sql": {LANG_VI: "SQL day du", LANG_JP: "Full SQL"},
    "history.detail.copy": {LANG_VI: "Copy", LANG_JP: "Copy"},
    "history.detail.use_insert": {LANG_VI: "Dung cho Insert", LANG_JP: "Use for Insert"},
    "history.detail.use_update": {LANG_VI: "Dung cho Update", LANG_JP: "Use for Update"},
    "history.msg.no_selection": {LANG_VI: "Chua chon ban ghi.", LANG_JP: "No row selected."},
    "history.msg.export_success": {LANG_VI: "Da xuat CSV.", LANG_JP: "CSV exported."},
    "history.msg.export_error": {LANG_VI: "Khong the xuat CSV.", LANG_JP: "Failed to export CSV."},
    "history.msg.clipboard": {LANG_VI: "Da copy vao clipboard.", LANG_JP: "Copied to clipboard."},
    "history.msg.no_window": {LANG_VI: "Khong tim thay cua so phu hop.", LANG_JP: "No target window."},
    "history.msg.open_error": {LANG_VI: "Khong mo duoc man hinh lich su: {error}", LANG_JP: "Cannot open history: {error}"},
